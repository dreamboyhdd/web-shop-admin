...
const SelectLanguageComp = ({
    ...
    const Shop_spLanguage_List = async () => {
        ...
        list.forEach((element, index) => {
            dataSelect.push({ value: element.LanguageId, label: element.Name });
        });
...
export const SelectLanguage = React.memo(SelectLanguageComp)