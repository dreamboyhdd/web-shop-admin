...
const SelectServiceComp = ({
    ...
    const Shop_spTypeService_List = async () => {
        const params = {
            Json: JSON.stringify({
                KeySelect: 1,
                UserId: User.UserId
            }),
            func: "Shop_spTypeService_List"
        }
        ...
        list.forEach((element, index) => {
            dataSelect.push({ value: element.TypeServiceId, label: element.TypeServiceName });
        });
