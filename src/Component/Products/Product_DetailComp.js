...
export const Product_DetailComp = ({
  ListData = [],
  onData = () => { },
  readOnly = false
}) => {
  const [Data, setData] = useState([]);
  const [Flag, setFlag] = useState(false); //Biến này thay đổi thì update lại ondata detail cho view sản phẩm
  ...
  return (
    <>
      <>
        <label className="no-absolute">Chi tiết sản phẩm</label>
        <table
          width={"100%"}
