...
export const MenuWebsiteManager = () => {
    const dispatch = useDispatch();
    useEffect(() => { }, []);

    const [Title, setTitle] = useState("Thêm menu website");
    ...
    //#region delete
    const Shop_spMenu_Delete = async (item) => {
        try {
    ...
    //#region show
    const Shop_spMenu_Hide = async (item) => {
        try {
    ...
    //#region change index
    const Shop_spMenu_ChangeIndex = async (item, key) => {
        try {
            ...
            Cell: ({ row }) => (
                <>
                    ...
                    <i
                        ...
                        onClick={(e) => Shop_spMenu_Delete({ row })}
                        title="Xóa"
                    />
                </>
            ),
                ...
                return (
                    <div>
                        {row._original.IsHide ? (
                            <a className="pointer" onClick={e => Shop_spMenu_Hide({ row })} title="Ẩn" >
                                <img src="../assets/img/icons8-toggle-off-50.png" className="transform-13" alt="Toggle Off" width="20" />
                            </a>
                        ) : (
                            <a className="pointer" onClick={e => Shop_spMenu_Hide({ row })} title="Hiện">
                    ...
                    <>
                        <div className="input-group" style={{ alignItems: 'center' }}>
                            <div className="input-group-prepend" >
                                <button className="btn btn-default btn-xs ipg-btn" type="button" onClick={(e) => Shop_spMenu_ChangeIndex({ row }, 'down')}>
                                    <i className="fa-solid fa-caret-down transform-16"></i>
                                </button>
                            </div>
                            <span className="ipg-text">{row._original.IndexNumber} </span>
                            <div className="input-group-append">
                                <button className="btn btn-default btn-xs ipg-btn" type="button" onClick={(e) => Shop_spMenu_ChangeIndex({ row }, 'up')}>
                    ...
                    <div className="row mt-3">
                        <div className="col-md-12">
                            ...
                            <div className="float-right">
                                ...
                                >
                                    <span>
                                        <i className="fa-solid fa-plus mr-2"></i>Thêm menu website
                                    </span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="float-right">
                                {ListData.length > 0 && <button
                                    ...
                                    disabled={!Disable2}
                                    onClick={e => Shop_spMenu_ExportExcel()}
                                >
